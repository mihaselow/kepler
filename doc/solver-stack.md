...
`solve_transient_heat` assembles a 2D `Tri3` heat-capacity matrix and conductivity matrix, reduces out prescribed temperature nodes, calls `solve_linear_transient`, and reconstructs full nodal temperatures for each step.
